...
import org.zerock.domain.TipAttachVO;
import org.zerock.domain.TipVO;
import org.zerock.service.TipService;
...
public class TipController {
	...
	*/
	...
	public void list(Criteria cri, Model model) {
		...
		// 그리고, http://localhost:9005/tip/list 웹사이트에서
	...
	public ResponseEntity<List<TipAttachVO>> getAttachList(Long bno){
	...
	// 때문에 편리합니다.
	// BoardController에서 register() 메서드는 "redirect:/tip/list"를
	// 전송하는데 브라우저는 이를 통보받은 후 "/tip/list"로 이동하게 됩니다.
	...
	public String register(TipVO board, RedirectAttributes rttr) {
...
//		log.info("/get 조회  처리");
	...
	@PostMapping("/modify")
	public String modify(TipVO board, @ModelAttribute("cri") Criteria cri, RedirectAttributes rttr) {
	...
	public String remove(@RequestParam("bno") Long bno, Criteria cri, RedirectAttributes rttr, String writer) {
		...
		List<TipAttachVO> attachList = service.getAttachList(bno);
