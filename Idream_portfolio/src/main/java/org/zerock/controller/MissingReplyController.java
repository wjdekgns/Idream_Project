...
public class MissingReplyController {
	...
	// 웹브라우저에 http://localhost:9005/Tipreplies/pages/720997/1 를 입력해서
	...
	// 댓글 조회 처리
	// 실행 확인은 웹브라우저에 http://localhost:9005/Tipreplies/99 주소로 확인합니다.
...
// YARC에서 URL: 란에 http://localhost:9005/Tipreplies/delete/73 입력하고,
