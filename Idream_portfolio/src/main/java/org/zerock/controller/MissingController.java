...
import org.zerock.domain.MissingAttachVO;
...
public class MissingController {
	...
	*/
	...
	public ResponseEntity<List<MissingAttachVO>> getAttachList(Long bno){
...
//		log.info("/get 조회  처리");
	...
	public String remove(@RequestParam("bno") Long bno, Criteria cri, RedirectAttributes rttr, String writer) {
		...
		List<MissingAttachVO> attachList = service.getAttachList(bno);
...
private void deleteFiles(List<MissingAttachVO> attachList) {
