...
import org.zerock.mapper.QAAttachMapper;
...
public class QAServiceImpl implements QAService {
	...
	@Setter(onMethod_ = @Autowired)
	private QAAttachMapper attachMapper;
	...
	// 특정 글 조회 작업의 기능 구현
	@Override
	public QAVO get(Long qno) {
		log.info("get... 특정 글 내용을 조회 합니다!" + qno);
	...
	public boolean modify(QAVO board) {
		...
		// 변경 사항도 확인해 주시기 바랍니다.
		attachMapper.deleteAll(board.getQno());
	...
	public boolean remove(Long qno) {
		...
		log.info("remove... 게시글을 삭제 처리 합니다!" + qno);
...
//	}
	...
	@Override
	public List<QAAttachVO> getAttachList(Long qno) {
