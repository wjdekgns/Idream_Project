...
window.onload = function() {
   ...
   join.pwCheck.onkeydown = function(){
      ...
      document.getElementById(errorId[0]).innerHTML = " 5~20자의 영문 대소문자, 숫자와 특수기호(_),(-)만 사용 가능합니다.";
      ...
      document.getElementById(errorId[1]).innerHTML = " 10~20자의 영문 대소문자, 숫자와 특수기호 '~!@#$%^&*()_-'만 사용 가능합니다.";
